...
- `lesson2.html` — 2차시. lesson1의 셸(헤더·TTS·볼륨·진행 점·칭찬·축하)을 복사해 만들었고, 스텝 타입은 `info`/`findkey`(위치 찾기)/`typeword`(자모 낱글자 따라 쓰고 지우기) 세 개. 파트(모듈) 2개: '키보드 위치 찾기'·'글자 따라 쓰기'. 내부 홈(카드 선택) 화면에 index.html로 나가는 '다른 수업 고르기' 링크.
