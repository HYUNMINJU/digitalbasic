...
- `lesson2.html` — 2차시. lesson1의 셸(헤더·TTS·볼륨·진행 점·칭찬·축하)을 복사해 만들었고, 스텝 타입은 `info`/`findkey`(위치 찾기)/`typeword`(자모 낱글자 따라 쓰고 지우기) 세 개. 모듈 1개라 시작 시 카드 화면 없이 바로 진입, 헤더 홈은 index.html로.
